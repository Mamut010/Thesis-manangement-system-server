...
*/
-- AlterTable
ALTER TABLE `BachelorThesisAssessment` MODIFY `supervisor1Id` INTEGER NULL,
    MODIFY `supervisor2Id` INTEGER NULL;

-- AlterTable
ALTER TABLE `OralDefenseAssessment` MODIFY `supervisor1Id` INTEGER NULL,
    MODIFY `supervisor2Id` INTEGER NULL;
