/*
  ...
  - You are about to drop the column `spectatorsPresent` on the `OralDefenseRegistration` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE `OralDefenseRegistration` DROP COLUMN `spectatorsPresent`,
    ADD COLUMN `areSpectatorsAllowed` BOOLEAN NULL,
