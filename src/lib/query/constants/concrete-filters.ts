...
export const ConcreteBinaryFilters = [StringFilter, NumberFilter, DateFilter, BooleanFilter] as const;
export const ConcreteListFilters = [StringListFilter, NumberListFilter, DateListFilter] as const;