...
export type ConcreteBinaryFilter = OneOf<[StringFilter, NumberFilter, DateFilter, BooleanFilter]>;
export type ConcreteListFilter = OneOf<[StringListFilter, NumberListFilter, DateListFilter]>;