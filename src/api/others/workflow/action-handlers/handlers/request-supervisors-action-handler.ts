...
@injectable()
export class RequestSupervisorsActionHandler extends SimpleRequestActionHandler {
    constructor(
        ...
        super(requestDataRepo, requestDataProcessor, [STORED_REQUEST_DATA_KEYS.Supervisor1, STORED_REQUEST_DATA_KEYS.Supervisor2], 
            notificationService);
    }
}